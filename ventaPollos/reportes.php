...
<div id="centralPanel">
	<div id="itemProveedores" class="centrarText">
		...
		<p><a href="gestionReporteVentas.php">Reporte de ventas</a></p>
	</div>
	
	<div id="itemProveedores" class="centrarText">
		<img src="imagenes/maquetado/reportes2.jpg" width="150px" height="150px" alt="Imagen reporte Compras" title="Reporte de compras" />
		<p><a href="gestionCompraVenta.php">Compras Vs Ventas</a></p>
	</div>
	
	<div id="itemProveedores" class="centrarText">
		<img src="imagenes/maquetado/reportes1.jpg" width="150px" height="150px" alt="Imagen reporte Movimientos" title="Reporte Movimientos" />
		<p><a href="reporteMovimientos.php">Movimientos Deposito</a></p>
	</div>
	<div id="itemProveedores" class="centrarText">
		<img src="imagenes/maquetado/subclientes.jpg" width="150px" height="150px" alt="Reporte Subclientes" title="Reporte Subclientes" />
		<p><a href="reporteSubclientes.php">Reporte SubClientes</a></p>
	</div>
	<div id="itemProveedores" class="centrarText">
		<img src="imagenes/maquetado/migrate.jpg" width="150px" height="150px" alt="Cons Totales" title="Totales" />
		<p><a href="reporteConsolidadoTotales.php">Consolidados Totales</a></p>
	</div>
</div>
<?php
require("footer.php");
