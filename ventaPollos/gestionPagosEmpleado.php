...
<div id="centralPanel">
	<h3 class="centrarText">Gesti&oacute;n pagos empleado</h3>
	<?php
	if ($rs->num_rows) {
	?>
	...
	?>
			<tr>
				<td><?php echo $periodoLaboral; ?></td>
				<td><?php echo $nombresEmpleado; ?></td>
	...
	<div id="divIngreso" class="oculto">
		<form action="ingresoPagoEmpleado.php" method="post" id="fIngPagoEmpleado">
			<fieldset>
			<legend>Datos nuevo pago empleado</legend>
