...
<div id="centralPanel">
	<h3 class="centrarText">Gesti&oacute;n de cuentas</h3>
	<?php
	if ($rs->num_rows) {
	?>
		<table>
			<tr>
				<th colspan="5">Listado de Cuentas de proveedores</th>
			</tr>
			<tr>
				<th>Proveedor</th>
				<th>Numero Cuenta</th>
				<th>Moneda</th>
				<th>Instituci&oacute Finac.</th>
				<th>Acciones</th>			
			</tr>
	<?php
	...
	<div id="divIngresoCuenta" class="oculto">
		<form action="ingresoCuenta.php" method="post" id="fIngCuenta">
			...
			<div class="claveValor">
				<label for="numeroCuenta">N&uacute;mero Cuenta: *</label>
				<input class="campoNormal" type="text" name="numeroCuenta" id="numeroCuenta" maxlength="16" />
			</div>
			
			<div class="claveValor">
				<label for="banco">Banco: *</label>
				<input class="campoMedioNormal" type="text" name="banco" id="banco" />
			</div>
